...
def parse_args():
    ...
    parser.add_argument('--all_actions_file', type=str, default="./comp_data/all_actions.json", help='all actions')
    ...
    parser.add_argument('--all_scene_ids_file', type=str, default="./comp_data/scene_ids.json", help='all situations ids')
